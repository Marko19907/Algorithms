...
public class InsertionSortTest {
    ...
    @Test
    @DisplayName("Tests insertion sorting")
    public void testSorting() {
        ...
        // Act
        sortedArray = InsertionSort.insertionSort(Arrays.copyOf(array, array.length));
    ...
    @Test
    @DisplayName("Tests insertion sorting with a longer list")
